        ...
        <div class="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
            <div class="grid w-full grid-cols-1 gap-6 mx-auto lg:grid-cols-3">
                ...
                @foreach ($curso as $nCurso)
                    <div class="p-6">
                        <a href="curso/actividades/{{ $nCurso->id}}" class="group relative block bg-black">
                            ...
                            <div class="relative p-4 sm:p-6 lg:p-8">
                                <p
                                    style=" text-shadow: 
                                -1px -1px 0 #df1bdf,  /* Sombra superior izquierda negra */
                                1px -1px 0 #df1bdf,  /* Sombra superior derecha negra */
                                -1px 1px 0 #df1bdf,  /* Sombra inferior izquierda negra */
                                1px 1px 0 #df1bdf,  /* Sombra inferior derecha negra */
                                0 0 5px #000000;
                                text-align: center;
                                ...
                                <p class="text-xl font-bold text-white sm:text-2xl">{{ $nCurso->name }}
                                    {{ $nCurso->last_name }} </th>
                                </p>
