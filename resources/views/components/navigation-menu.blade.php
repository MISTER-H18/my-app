    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden lg:hidden">
                    ...
                    <div class="group"> {{-- click here --}}
                        <x-responsive-nav-link cla ss="select-none">
                            <div class="m-0 mx-auto p-0 flex items-center">
                                ...
                                <svg class="ms-2 -me-0.5 h-4 w-4 ml-1 rotate-0 group-hover:rotate-180 transition-transform"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        ...
                        <div class="hidden group-hover:block transition-transform">{{-- display here --}}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div>
                    <div class="font-medium text-base text-gray-800">{{ Str::ucfirst(Auth::user()->name) }}
                        {{ Str::ucfirst(Auth::user()->last_name) }}</div>
