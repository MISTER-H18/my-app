<x-form-section submit="createMember" method="POST" action="{{ route('members.store') }}">
    <x-slot name="title">
        {{ __('Create') }} {{ __('Members') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Create a new record for members and insert it into the database.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="name" type="text" inputmode="text" pattern="[a-zA-Z]+" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="occupation" type="text" inputmode="text" pattern="[a-zA-Z]+" class="mt-1 block w-full"
                name="occupation" autofocus autocomplete="occupation" />
